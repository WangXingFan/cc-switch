...
export function useSettingsForm(): UseSettingsFormResult {
  ...
  useEffect(() => {
    ...
    const normalized: SettingsFormState = {
      ...
      enableMultiKeyBalanceQuery: data.enableMultiKeyBalanceQuery ?? false,
      ...
      setSettingsState((prev) => {
        const base =
          ...
          ({
            ...
            enableMultiKeyBalanceQuery: false,
  ...
  const resetSettings = useCallback(
    (serverData: Settings | null) => {
      ...
      const normalized: SettingsFormState = {
        ...
        enableMultiKeyBalanceQuery:
          serverData.enableMultiKeyBalanceQuery ?? false,
